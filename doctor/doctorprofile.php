...
$res=mysqli_query($con,"UPDATE doctor SET doctorFirstName='$doctorFirstName', doctorLastName='$doctorLastName', doctorPhone='$doctorPhone', doctorEmail='$doctorEmail', doctorAddress='$doctorAddress' WHERE doctor_id=".$_SESSION['doctorSession']);
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <table class="table table-user-information" align="center">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Profession</td>
                                                    <td><?php echo $userRow['doctorSpecialty']; ?></td>
                                                </tr>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="<?php $_PHP_SELF ?>" method="post" >
                                            <table class="table table-user-information">
                                                ...
                                                <tr>
                                                        <td>ID number:</td>
                                                        <td><input type="text" class="form-control" name="doctor_id" value="<?php echo $userRow['doctor_id']; ?>" disabled /></td>
                                                    </tr>
                                                    <tr>
                                                        <td>First Name:</td>
