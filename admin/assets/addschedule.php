...
$res=mysqli_query($con,"SELECT * FROM Receptionist WHERE receptionist_id=".$usersession);
...
$starttime     = mysqli_real_escape_string($con,$_POST['schedule_startTime']);
$endtime     = mysqli_real_escape_string($con,$_POST['schedule_endTime']);
$bookavail         = mysqli_real_escape_string($con,$_POST['bookavail']);

//INSERT
$query = " INSERT INTO Receptionistschedule (  scheduleDate, scheduleDay, startTime, endTime,  bookAvail)
...
<html lang="en">
    <head>
        ...
        <title>Welcome Dr <?php echo $userRow['ReceptionistFirstName'];?> <?php echo $userRow['ReceptionistLastName'];?></title>
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="Receptionistdashboard.php">Welcome Dr <?php echo $userRow['ReceptionistFirstName'];?> <?php echo $userRow['ReceptionistLastName'];?></a>
                </div>
                <!-- Top Menu Items -->
                <ul class="nav navbar-right top-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="Receptionistprofile.php"><i class="fa fa-fw fa-user"></i> Profile</a>
                            </li>
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        <li>
                            <a href="Receptionistdashboard.php"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                        </li>
                        <li class="active">
                            <a href="addschedule.php"><i class="fa fa-fw fa-table"></i> Receptionist Schedule</a>
                        </li>
                        <li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php 
                            $result=mysqli_query($con,"SELECT * FROM Receptionistschedule");
                            

                                  
                            while ($Receptionistschedule=mysqli_fetch_array($result)) {
                                
                              
                                echo "<tbody>";
                                echo "<tr>";
                                    echo "<td>" . $Receptionistschedule['schedule_id'] . "</td>";
                                    echo "<td>" . $Receptionistschedule['schedule_date'] . "</td>";
                                    echo "<td>" . $Receptionistschedule['scheduleDay'] . "</td>";
                                    echo "<td>" . $Receptionistschedule['schedule_startTime'] . "</td>";
                                    echo "<td>" . $Receptionistschedule['schedule_endTime'] . "</td>";
                                    echo "<td>" . $Receptionistschedule['bookAvail'] . "</td>";
                                    echo "<form method='POST'>";
                                    echo "<td class='text-center'><a href='#' id='".$Receptionistschedule['schedule_id']."' class='delete'><span class='fa fa-trash' aria-hidden='true'></span></a>
                            </td>";
