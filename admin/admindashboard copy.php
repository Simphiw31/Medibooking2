...
$res=mysqli_query($con,"SELECT * FROM administrator WHERE adminEmail= '$usersession'");
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="doctordashboard.php">Welcome Admin <?php echo $userRow['name'];?> <?php echo $userRow['surname'];?></a>
                </div>
                <!-- Top Menu Items -->
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            <a href="adminaddschedule.php"><i class="fa fa-fw fa-table"></i> Doctor Schedule</a>
                        </li>
                        <li>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Symptomps" disabled></th>
                            ...
                            while ($appointment=mysqli_fetch_array($res)) {
                                ...
                                if ($appointment['appointment_status']=='notAttended') {
                                    $status="danger";
                                    $icon='remove';
                                    $checked='';
                                ...
                                echo "<tr class='$status'>";
                                    ...
                                    echo "<td><span class='glyphicon glyphicon-".$icon."' aria-hidden='true'></span>".' '."". $appointment['appointment_status'] . "</td>";
                                    ...
                                    echo "<td class='text-center'><a href='#' id='".$appointment['appointment_ID']."' class='delete'><span class='fa fa-trash' aria-hidden='true'></span></a>
                            </td>";
