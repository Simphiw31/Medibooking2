...
if (isset($_POST['submit'])) {
    ...
    $doctorSpecialty     = mysqli_real_escape_string($con,$_POST['doctorSpecialty']);
    ...
    //INSERT
    $query = " INSERT INTO doctor (  doctorPassord, doctorFirstName, doctorLastName,  doctor_id,doctorEmail,doctorSpecialty,admin_id)
    VALUES ( '$password', '$doctorFirstName', '$doctorLastName', '$doctor_id' ,'$doctorEmail','$doctorSpecialty','$admin_id'  ) ";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Add Doctor</button>
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    <th><input type="text" class="form-control" placeholder="Dr ID" disabled></th>
                            ...
                            while ($doctorRow=mysqli_fetch_array($result)) {
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td>" . $doctorRow['doctorLastName'] .' ' . $doctorRow['doctorFirstName'] . "</td>";
                                    echo "<td>" . $doctorRow['doctorSpecialty'] . "</td>";
                                    echo "<td>" . $doctorRow['doctorEmail'] . "</td>";
                                    echo "<form method='POST'>";
                                    echo "<td class='text-center'><a href='#' id='".$doctorRow['doctor_id']."' class='delete'><span class='fa fa-trash' aria-hidden='true'></span></a>
                            </td>";
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <h4>Enter Doctor's Details.</h4>
                                        <input type="text" name="doctor_id" value="" class="form-control input-lg" placeholder="Doctor's Id"  required/>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-6">
                                                <input type="text" name="doctorFirstName" value="" class="form-control input-lg" placeholder="Doctor's First Name" required />
                                            </div>
                                            <div class="col-xs-6 col-md-6">
                                                <input type="text" name="doctorLastName" value="" class="form-control input-lg" placeholder="Doctor's Last Name" required />
                                            </div>
                                        </div>
                                        <input type="text" name="doctorEmail" value="" class="form-control input-lg" placeholder="Doctor's Email"  required/>
                                        <input type="text" name="doctorSpecialty" value="" class="form-control input-lg" placeholder="Doctor's profession"  required/>
                                    ...
                                    <br>
                                        <button class="btn btn-lg btn-primary btn-block signup-btn" type="submit" name="submit">Add Doctor</button>
                                    </form>
                                        <!-- form end -->
                                        </div>
