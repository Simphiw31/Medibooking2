...
$res=mysqli_query($con,"SELECT * FROM adminstrator WHERE   email= '$usersession'");
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="Receptionistdashboard.php">Welcome Admin <?php echo $userRow['name'];?> <?php echo $userRow['surname'];?></a>
                </div>
                <!-- Top Menu Items -->
