...
$res=mysqli_query($con,"SELECT * FROM patient a,city b,province c 
						WHERE patient_id='$usersession' 
						AND c.provinceZipCode=b.provinceZipCode
						AND b.cityZipCode=a.cityZipCode");
...
$res=mysqli_query($con,"UPDATE patient SET patientFirstName='$patientFirstName', patientLastName='$patientLastName', patientMaritialStatus='$patientMaritialStatus', patientGender='$gender', patientStreetAddress='$patientStreetAddress', patientPhone='$patientPhone', patientEmail='$patientEmail' WHERE patient_id= '$usersession'");
									...
									<div class="panel-body">
										...
										<table class="table table-user-information" align="center">
											<tbody>
												...
												<tr>
													<td>Date of birth</td>
													<td><?php echo substr($userRow['patient_id'],4,2); ?>/
														<?php echo substr($userRow['patient_id'],2,2); ?>/
														<?php if(substr($userRow['patient_id'],0,1)>1){?>
														19<?php }else {
																?> 20
																<?php }
																echo substr($userRow['patient_id'],0,2); ?>	
												</td>
												</tr>
												<tr>
													<td>Gender</td>
												...
												<tr>
													<td>Address</td>
													<td><?php echo $userRow['patientStreetAddress']; ?><br><br>
														<?php echo $userRow['provinceCountry']; ?> ,
										...
										<form action="<?php $_PHP_SELF ?>" method="post" >
											<table class="table table-user-information">
												<tbody>
													...
													<tr>
														<td>Phone number</td>
														<td><input type="text" class="form-control" name="Phone" value="<?php echo $userRow['patientPhone']; ?>"  /></td>
													</tr>
													<tr>
														<td>Email</td>
													...
													<tr>
														<td>Address</td>
														<td><textarea class="form-control" name="patientStreetAddress"  ><?php echo $userRow['patientStreetAddress']; ?></textarea></td>
													</tr>
													<tr>
														<td>
