...
if(isset($_POST['searchAppointment'])){
	...
	$res=mysqli_query($con,"SELECT * FROM schedule ");//WHERE schedule_date = '$$date' AND doctor_id = '$doctor'");
					...
					<div class="col-xs-12 col-md-8">
						...
						// <!-- / notification start -->
							...
							?><div class="input-group" style="margin-bottom:10px;">
								...
								show schedule slots for : <input method="post" type="date" id="date" name="appdate" value="<?php echo date("Y-m-d")?>"/>
                            	&nbsp;&nbsp;&nbsp; For &nbsp;&nbsp;&nbsp;
								<select name="doctor" >
                                    ...
                                    echo"</select>";?>
									<button type="submit" name="search" class="btn btn-block btn-warning"><i class="fa fa-search" aria-hidden="true"></i>Search appointment date </button>
									</form>
						...
						xmlhttp.open("GET","getschedule.php?q="+str+"&p="+doctor,true);
						console.log(str);
						xmlhttp.send();
						}else {
						if (window.XMLHttpRequest) {
