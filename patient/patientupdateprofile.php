...
$res=mysqli_query($con,"SELECT * FROM patient WHERE patient_id=".$_SESSION['patientSession']);
...
$res=mysqli_query($con,"UPDATE patient SET patientFirstName='$patientFirstName', patientLastName='$patientLastName', patientMaritialStatus='$patientMaritialStatus', patientDOB='$patientDOB', gender='$gender', patientStreetAddress='$patientStreetAddress', patientPhone=$patientPhone, patientEmail='$patientEmail' WHERE patient_id=".$_SESSION['patientSession']);
                                                ...
                                                <form action="<?php $_PHP_SELF ?>" method="post" name="form1" id="form1">
                                                    <table class="table table-user-information">
                                                        <tbody>
                                                            ...
                                                            <!-- radio button end -->
                                                            <tr>
                                                                <td>patientStreetAddress</td>
                                                                <td><input type="text" class="form-control" name="patientStreetAddress" value="<?php echo $userRow['patientStreetAddress']; ?>"  /></td>
                                                            </tr>
                                                            <tr>
                                                                <td>PatientPhone</td>
